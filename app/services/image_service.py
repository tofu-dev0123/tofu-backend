...
class ImageService:
    ...
    def upload_file(self, image_file: UploadFile, alt_text: str | None) -> ImageUploadResponse:
        image_file.file.seek(0)
        ...
        try:
            ...
            return ImageUploadResponse(image_id=new_image_id, url=url, alt_text=alt_text)
